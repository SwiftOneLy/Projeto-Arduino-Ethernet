...
hashtag#include <DistanceSensor.h>
hashtag#include <unistd.h>

hashtag#define VERMELHO 8
...
<html lang="pt-BR">
 ...
 // alert("ALERTA: a distância está abaixo de 10. Todos entrem em pânico!");
 } else {
 warning.innerText = "Cuidado, a distância está abaixo de 30.";
 // alert("Cuidado, a distância está abaixo de 30.");
 }
 } else {
 warning.innerText = "";
 }
